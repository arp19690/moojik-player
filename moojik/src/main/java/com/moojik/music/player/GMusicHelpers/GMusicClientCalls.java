 ...
 */
package com.moojik.music.player.GMusicHelpers;
...
public class GMusicClientCalls {
	...
	private static final String getXtCookieValue() {
		...
		for(cz.msebera.android.httpclient.cookie.Cookie cookie : mCookieStore.getCookies()) {
	...
	public static final URI getSongStream(String songId) 
		...
		RequestHandle response = mHttpClient.get("https://play.google.com/music/play", (ResponseHandlerInterface) params);
	 ...
	 * 
	 * @param playlistEntryId The playlistId of the playlist to delete.
	 * @throws JSONException
	 * @throws IllegalArgumentException
	 *****************************************************************************/
