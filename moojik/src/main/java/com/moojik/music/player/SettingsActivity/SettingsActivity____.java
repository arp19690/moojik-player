...
import com.moojik.music.player.AsyncTasks.AsyncGoogleMusicAuthenticationTask;
import com.moojik.music.player.BlacklistManagerActivity.BlacklistManagerActivity;
import com.moojik.music.player.Helpers.TypefaceHelper;
import com.moojik.music.player.Helpers.UIElementsHelper;
import com.moojik.music.player.InAppBilling.IabHelper;
import com.moojik.music.player.InAppBilling.IabResult;
import com.moojik.music.player.InAppBilling.Purchase;
import com.moojik.music.player.Services.AutoFetchAlbumArtService;
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	upgradePreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				//initInAppBilling();
				Intent intent = new Intent(mContext, com.moojik.music.player.LauncherActivity.LauncherActivity.class);
