...
import com.moojik.music.player.fragments.PlaylistFragment;
import com.moojik.music.player.fragments.QueueFragment;
import com.moojik.music.player.permissions.Nammu;
import com.moojik.music.player.permissions.PermissionCallback;
import com.moojik.music.player.slidinguppanel.SlidingUpPanelLayout;
...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer {
    ...
    Runnable navigateArtist = new Runnable() {
        public void run() {
            ...
            ArtistDetailFragment fragment = ArtistDetailFragment.newInstance(artistID, false, null);
            FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction()
                    .replace(R.id.fragment_container, fragment).commit();
        }
    ...
    private void updatePosition(final MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_help:
                ...
                Uri data = Uri.parse("mailto:arp19690@yahoo.com");
                intent.setData(data);
